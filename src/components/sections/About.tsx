    ...
    <Section className={clsx(animationClass, 'mx-auto max-w-4xl')}>
      ...
      <div className='md:px-0 [&_p]:text-muted-dark [&_p]:dark:text-muted'>
        ...
        <p className='animate-fade-in !delay-300'>
          I'm currently a <strong className="text-primary-dark dark:text-primary-light">Senior iOS Developer</strong> at <InlineLink href="https://valora.com">Valora Schweiz AG</InlineLink> where I develop new iOS applications and enhance existing ones using Swift, SwiftUI, and UIKit. I collaborate closely with iOS, Android, and backend developers to define new interfaces and conduct cross-platform code reviews to ensure feature parity across platforms.
        </p>
        ...
        <Heading2 className='animate-fade-in !delay-500 mb-6 mt-12'>Experience</Heading2>

        <Heading3 className='animate-fade-in !delay-600 mb-4 mt-8'>Recent Positions</Heading3>
        ...
        <div className="animate-fade-in !delay-800 mb-6">
        ...
        <div className="animate-fade-in !delay-900 mb-6">
        ...
        <Heading2 className='animate-fade-in !delay-1000 mb-6 mt-12'>Skills</Heading2>
        <p className='animate-fade-in !delay-1100'>Here are the technologies I specialize in:</p>

        <Heading3 className='animate-fade-in !delay-1200 mb-4 mt-8'>iOS Development</Heading3>
        <ul className='animate-fade-in !delay-1300 mb-8 flex flex-wrap gap-2'>
        ...
        <Heading3 className='animate-fade-in !delay-1400 mb-4 mt-8'>Mobile Technologies</Heading3>
        <ul className='animate-fade-in !delay-1500 mb-8 flex flex-wrap gap-2'>
        ...
        <Heading3 className='animate-fade-in !delay-1600 mb-4 mt-8'>Development Tools & Practices</Heading3>
        <ul className='animate-fade-in !delay-1700 mb-8 flex flex-wrap gap-2'>
        ...
        <Heading3 className='animate-fade-in !delay-1800 mb-4 mt-8'>Additional Skills</Heading3>
        <ul className='animate-fade-in !delay-1900 mb-8 flex flex-wrap gap-2'>
        ...
        <Heading2 className='animate-fade-in !delay-2000 mb-6 mt-12'>Hobbies & Interests</Heading2>
        <p className='animate-fade-in !delay-2100'>
        ...
        <Heading2 className='animate-fade-in !delay-2200 mb-6 mt-12'>Contact Me</Heading2>
        <p className='animate-fade-in !delay-2300'>
        ...
        <p className='animate-fade-in !delay-2400'>
